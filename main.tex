...
v1.0.0\quad 版本日期：\today\\
项目：https://github.com/ErSanSan233/riichi-mahjong-one-page\\
字体：https://mahjongfont.pages.dev\\
}
\end{center}
\vfill
...
\node[tag] (t10) at (0, 22*y) {看运气};
    ...
    \node[tag] (t11) at (.3*x, 25.3*y) {和最后1张};
